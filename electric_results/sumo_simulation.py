...
if __name__ == '__main__':
    ...
    route1_paths = ['config_files/route1/config1_1.sumocfg']

    route2_paths = ['config_files/route2/config2_1.sumocfg']
    
    route3_paths = ['config_files/route3/config3_1.sumocfg']
    
    route4_paths = ['config_files/route4/config4_1.sumocfg']

    route5_paths = ['config_files/route5/config5_1.sumocfg']

    route6_paths = ['config_files/route6/config6_1.sumocfg']
