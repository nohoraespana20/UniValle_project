...
if __name__ == '__main__':
    ...
    route1_paths = ['config_files2/route1/config1_1.sumocfg', 'config_files2/route1/config1_2.sumocfg', 
                    'config_files2/route1/config1_3.sumocfg', 'config_files2/route1/config1_4.sumocfg', 
                    'config_files2/route1/config1_5.sumocfg']

    route2_paths = ['config_files2/route2/config2_1.sumocfg', 'config_files2/route2/config2_2.sumocfg', 
                    'config_files2/route2/config2_3.sumocfg', 'config_files2/route2/config2_4.sumocfg', 
                    'config_files2/route2/config2_5.sumocfg']
    
    route3_paths = ['config_files2/route3/config3_1.sumocfg', 'config_files2/route3/config3_2.sumocfg', 
                    'config_files2/route3/config3_3.sumocfg', 'config_files2/route3/config3_4.sumocfg', 
                    'config_files2/route3/config3_5.sumocfg']
    
    route4_paths = ['config_files2/route4/config4_1.sumocfg', 'config_files2/route4/config4_2.sumocfg', 
                    'config_files2/route4/config4_3.sumocfg', 'config_files2/route4/config4_4.sumocfg', 
                    'config_files2/route4/config4_5.sumocfg']

    route5_paths = ['config_files2/route5/config5_1.sumocfg', 'config_files2/route5/config5_2.sumocfg', 
                    'config_files2/route5/config5_3.sumocfg', 'config_files2/route5/config5_4.sumocfg', 
                    'config_files2/route5/config5_5.sumocfg']

    route6_paths = ['config_files2/route6/config6_1.sumocfg', 'config_files2/route6/config6_2.sumocfg', 
                    'config_files2/route6/config6_3.sumocfg', 'config_files2/route6/config6_4.sumocfg', 
                    'config_files2/route6/config6_5.sumocfg']
