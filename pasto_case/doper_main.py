...
from pasto_case.doper_parameter import parameters, ts_inputs
...
if __name__ == '__main__':  
    ...
    demand_L1 = [11.2, 105.6, 304.5, 709.0, 1353.9, 909.9, 2684.1, 139.3, 21.6,5031.2,
    ...
    demand_L2 = [8.9, 38.7, 582.5, 1155.6, 2989.8, 6340.0, 9108.8, 23724.3, 11865.5, 
    ...
    #DEMAND L3 FAST
    demand_L3 = [4.7, 226.5, 134.2, 522.4, 87.2,  1514.9, 124.9, 497.5, 14610.3, 4553.6, 
              13179.0, 983.2, 1183.4, 32933.0, 492.7, 112.1, 52.1, 76430.1, 41323.4,
              53832.9, 150721.6, 102287.8, 10489.3, 208568.5, 111.6, 16747.6, 3055.4,
              227745.7, 164255.1, 62742.2]
