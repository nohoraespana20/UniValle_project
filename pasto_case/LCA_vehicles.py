...
# Datos
categories = ['Producción', 'Utilización', 'Reciclaje']
technologies = ['VCI', 'VE', 'VGN', 'VHEE']
data = {
    'Producción': [4076.64, 34281.9, 4076.64, 13490.4],
    'Utilización': [267691.0, 28178.0, 183157.0, 58018.5],
    'Reciclaje': [2619.42, 20341.6, 2619.42, 8290.0]
}
