...
# df = pd.DataFrame({'Case 1 NGV': gas1, 'Case 2 NGV': gas2, 'Case 3 EV-L3': evl33, 'Case 4 EV-L2': evl24}, index=Y)
...
Y = ['Availability Factor', 'Driving Range', 'Accumulated Cost', 'Incentives', ' Emissions','DPI','DNI','CC']
...
df = pd.DataFrame({'Case 1 NGV': gas1, 'Case 2 NGV': gas2, 'Case 3 EV-L2': evl23, 'Case 4 NGV': gas4}, index=Y)
df.plot( kind = 'bar', width=0.7, rot=0, color=['#006cbe', '#00a0dc', '#00d0db', '#73fac9'], fontsize=7)
